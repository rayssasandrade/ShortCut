...
namespace SisGerenciador.Views
{
    ...
    public class InstituicoesController : Controller
    {
        ...
        public InstituicoesController(MeuContexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Sigla,Descricao")] Instituicao instituicao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Sigla,Descricao")] Instituicao instituicao)
        {
